    ...
    <div class="footer-content">
        <div class="footer-grid">
            <div class="footer-section">
                <h3>Om KSDK</h3>
                <p>Karlskoga Sportdykarklubb grundades 1965 och är en ideell förening för alla som är intresserade av dykning.</p>
            </div>
            ...
            <div class="footer-section">
                ...
                <ul class="footer-contact">
                    ...
                    <li>
                        ...
                        <a href="mailto:info@karlskogasdk.se">info@karlskogasdk.se</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="footer-bottom">
            <p>&copy; <?php echo date('Y'); ?> Karlskoga Sportdykarklubb</p>
